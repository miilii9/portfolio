...
export default function MenuButton({ toggleMenu, open }) {
    return (
        <label className={`${styles.hamburger} md:hidden sm:block z-40`}>
            <input value="" onClick={toggleMenu} checked={open} readOnly type="checkbox" />
